  ...
  return (
    <div onClick={closeMenu} className={style.Container}>
      <div className={style.Left}>
        {post && <Image placeholder="blur" blurDataURL={`http://localhost:5001${post.blur&&post.blur_src}`} style={{ borderRadius: "5px" }} objectFit="cover" src={`http://localhost:5001${post.src}`} height={370} width={370} />}
      </div>
      <div className={style.Right}>
        <div className={style.Right_left}></div>
